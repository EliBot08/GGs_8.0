...
:: ============================================================================
:: GGs Desktop Launcher
:: Enterprise-grade launcher for GGs Desktop application
:: Zero coding knowledge required - just double-click to run
:: ============================================================================

title GGs Desktop Launcher
...
:: Launch with desktop profile
echo [INFO] Launching GGs Desktop...
echo.

"%LAUNCH_CONTROL%" --profile desktop --mode normal
...
echo.
echo [SUCCESS] Desktop application launched successfully
echo.
