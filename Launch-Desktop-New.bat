...
REM ============================================================================
REM  GGs Desktop Application Launcher - Enterprise Edition (Process-Safe)
REM ============================================================================
REM  Kills any running instance of GGs.Desktop.exe before building to avoid file lock errors.
REM ============================================================================

REM Set console colors and title
color 0B
set "LAUNCHER_TITLE=GGs Desktop Application Launcher - Enterprise Edition"
...
REM ============================================================================
echo.
echo [STEP 0/4] Checking for running desktop instances...
call :LOG "Checking for running desktop instances..."
...
REM ============================================================================
echo.
echo [STEP 1/4] Building latest Desktop code...
...
REM ============================================================================
echo [STEP 4/4] Launching Desktop Application...
...
call :LOG "Desktop launcher finished."
exit /b 0
